...
if NO_TOKEN:
    ...
    access_token = 'b6_3pfGGwEgiSSivKqnmQfFK59dIENPZrQgq9fo9MouKDIwNCFVGNsE_8Y'\
        '62beAvckgNEEjEXsdBvBmPfMJql1ECdgRlo_GULMgGZS0EumxrKbZFiOmnmAPChBPDZ5JP'
    refresh_token = 'oAiwG8gfPrCLpr_xOljdZrRWJfxTwsW1gltsDCH6KQvdL2WxNgQvKekaC'\
        'y5aBtavNNWfJhnfRQwlAN2iCODyqw'
...
for val in xrange(1, 32):
    out_file = open('/tmp/sleep03%s' % val, 'w');
